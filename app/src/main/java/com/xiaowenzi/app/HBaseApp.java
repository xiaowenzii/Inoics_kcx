...
public class HBaseApp extends Application {
	...
	public Handler getWorkHandler() {
		return (mWorkHandler != null) ? (mWorkHandler) : (mWorkHandler = new Handler(getWorkLooper()));
	}
	...
	static public boolean post2WorkRunnable(Runnable r) {
		return (s_instance != null) ? s_instance.getWorkHandler().post(r) : false;
	}
